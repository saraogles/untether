...
{ name: 'Get Started Today', href: '#', icon: PhoneIcon },
]
...
const enterprise = [
  { name: 'Case Studies', href: '#', icon: InformationCircleIcon },
  { name: 'Technical Expertise', href: '#', icon: OfficeBuildingIcon },
  { name: 'Integrations', href: '#', icon: NewspaperIcon },
  { name: 'Meet the Team', href: '#', icon: BriefcaseIcon },
  { name: 'Business Portal', href: '#', icon: ShieldCheckIcon },
]
const education = [
  { name: 'Educator Services', href: '#', icon: UserGroupIcon },
  { name: 'Untethered Blog', href: '#', icon: GlobeAltIcon },
  { name: 'In the Media', href: '#', icon: BookmarkAltIcon },
...
const navigation = {
  ...
  education: [
    { name: 'Educator Services', href: '#' },
    { name: 'Untethered Blog', href: '#' },
    { name: 'In The Media', href: '#' },
    { name: 'Educator Portal', href: '#' },
  ],
  enterprise: [
    { name: 'Case Studies', href: '#' },
    { name: 'Technical Expertise', href: '#' },
